...
public class pin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("enter your 4 digit pin here ");
        ...
        try{
                    ...
                    if(con.isValid(1))
                    {
                        ...
                        ResultSet resultSet=ps.executeQuery();
                         if(resultSet.next()){
                             Start.setUser(resultSet.getString("username"), resultSet.getString("accountnumber"));
                             new Start().setVisible(true);
                             this.dispose();
                        }
                         else{
                             JOptionPane.showMessageDialog(rootPane, "enter pin correctly");
                         }
